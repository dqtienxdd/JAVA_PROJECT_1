...
public class OctagonManager {
    ...
    public void draw(Graphics2D g2){
        ...
        g2.drawImage(backside.image, 300, 140 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 396, 140 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 300, 215 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 396, 215 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 300, 290 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 396, 290 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 300, 365 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 396, 365 , gp.octagonSize, gp.octagonSize, null);

        g2.drawImage(backside.image, 204, 215 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 492, 215 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 204, 290 , gp.octagonSize, gp.octagonSize, null);
        g2.drawImage(backside.image, 492, 290 , gp.octagonSize, gp.octagonSize, null);
